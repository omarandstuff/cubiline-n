...
public class CubilineChallengeController : MonoBehaviour
{
	//////////////////////////////////////////////////////////////
	///////////////////////// COMPONENTS /////////////////////////
	//////////////////////////////////////////////////////////////
	...
	public void Reset()
	{
		arenaController.Reset(size);
		followCamera.transform.localPosition = new Vector3(0.0f, 0.0f, -size * 2.0f);

		player.Reset(size);
		player.speed = speed;
		player.hardMove = CubilineApplication.hardMove;

		followTarget.transform.position = new Vector3(-size * 2, 0, -size / 2);
	}

	void GoOut()
	{
		outTarget.transform.position = followCamera.transform.localPosition + (followCamera.transform.localPosition - followCamera.target.transform.localPosition).normalized * size;
