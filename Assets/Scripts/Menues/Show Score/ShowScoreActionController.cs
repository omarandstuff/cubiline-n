...
public class ShowScoreActionController : ActionContentController
{
	...
	IEnumerator Start()
	{
		...
		score.score = CubilineScoreController.currentScore;
	...
	private IEnumerator PublicScore()
	{
		...
		form.AddField("demo_score[players]", CubilineApplication.player1Name + " Feat. " + CubilineApplication.player2Name);
		form.AddField("demo_score[score]", CubilineScoreController.currentScore.ToString());
